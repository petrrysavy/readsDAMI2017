...
/**
 * Immutable set that stores two values. This wrapper can be used for example
 * for indexing the hash maps, as return value or similar purposes.
 *
...
public class PairSet<E> implements Set<E>, Cloneable {
    ...
    /**
     * Returns one of the stored values. The value is the other that is returned
     * by {@code getValue2} method.
     *
     ...
     * @throws IllegalArgumentException When the element {@code e} is not in
     * this set.
     */
    ...
    private class ValueIterator implements Iterator<E> {
         ...
         *
         * @throws UnsupportedOperationException Is always thrown when calling
         * this method.
         */
        @Override
        public void remove() {
